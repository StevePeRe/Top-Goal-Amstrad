...
# $(eval $(call ADD2PACK,fondo_estadio_z,src/sprites/estadio.bin))
# $(eval $(call PACKZX7B,fondo_estadio_z,src/sprites/))
$(eval $(call ADD2PACK,fondo_menu,src/sprites/menu.bin))
$(eval $(call PACKZX7B,fondo_menu,src/sprites/))

$(eval $(call ADD2PACK,fondo_controles,src/sprites/controles.bin))
$(eval $(call PACKZX7B,fondo_controles,src/sprites/))

# $(eval $(call ADD2PACK,fondo_winner1,src/sprites/win1.bin))
# $(eval $(call PACKZX7B,fondo_winner1,src/sprites/))

$(eval $(call ADD2PACK,fondo_estadio,src/sprites/estadio.bin))
$(eval $(call PACKZX7B,fondo_estadio,src/sprites/))

$(eval $(call ADD2PACK,player1_wins,src/sprites/player1_wins.bin))
$(eval $(call PACKZX7B,player1_wins,src/sprites/))

$(eval $(call ADD2PACK,player2_wins,src/sprites/player2_wins.bin))
$(eval $(call PACKZX7B,player2_wins,src/sprites/))

# $(eval $(call ADD2PACK,fondo_winner2,src/sprites/win2.bin))
# $(eval $(call PACKZX7B,fondo_winner2,src/sprites/))
